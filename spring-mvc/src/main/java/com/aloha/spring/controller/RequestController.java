...
@Controller						// Controller 지정하고 빈 등
...
//	@RequestMapping( value = "/board", method = RequestMethod.GET)
	 ...
	 * @param id
	 * @return
	 * * params 속성으로 요청파라미터가 id 인 경우 매핑한다.
	...
	public String requestParams(
		...
		logger.info("[GET] - /request/board?id=" + id + "&" + age);
		logger.info("id : " + id);
		logger.info("age : " + age);
		return "request/board";
	}
	...
	@RequestMapping(value = {"/board","/board2"}, method = RequestMethod.POST,
				...
				// ,headers = {"Content-Type=appication/json", "헤더2", "헤더3:})
